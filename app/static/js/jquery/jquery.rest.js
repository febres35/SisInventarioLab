...
(function($) {
	...
	var SOAPObject = function(name) {
		...
		this.val = function(value) {
			if (value === undefined) {
				return (this.attr('xsi:nil') === 'true') ? null : this.value ;
			} else if (value !== null) {
				this.value = value;
				return this;
			} else {
	...
	var SOAPResponse = function(status, xhr) {
		...
		this.toString = function(){
			...
			this.content = (this.content != undefined) ? $.type(this.content) : 'Unknow Error.' ;
			throw new Error("Unexpected Content: " + this.content);
		};
		this.toXML = function(){
			if ($.isXMLDoc(this.content)) {
				return this.content;
